...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__plugins_event_bus__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_v_toaster_evolution__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_v_toaster_evolution_dist_v_toaster_evolution_css__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utilities_locate_vee_validate_es__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Module_vue__ = __webpack_require__(17);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_4_vee_validate__["b" /* default */], config);
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1__plugins_event_bus__["a" /* default */]);
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_2_v_toaster_evolution___default.a, { timeout: 10000 });
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SubModule_vue__ = __webpack_require__(19);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    isParent: function isParent() {
      return this.subModule.childrens && this.subModule.childrens.length;
    }
  },
  mounted: function mounted() {
...
var render = function() {
  ...
  return _c("li", [
    _c("a", { staticClass: "redirect", attrs: { href: _vm.subModule.url } }, [
      _vm.isParent ? _c("i", { staticClass: "fa fa-sitemap" }) : _vm._e(),
      _vm._v(" "),
      !_vm.isParent
        ? _c("i", { staticClass: "glyphicon glyphicon-new-window" })
        : _vm._e(),
      _vm._v(" \n      " + _vm._s(_vm.subModule.name) + "\n      "),
      _vm.isParent ? _c("span", { staticClass: "fa arrow" }) : _vm._e()
    ]),
    _vm._v(" "),
    _vm._m(0),
    _vm._v(" "),
    _vm.isParent
      ? _c(
          "ul",
          { staticClass: "nav" },
          _vm._l(_vm.subModule.childrens, function(subModule) {
  ...
  function() {
    ...
    return _c("div", { staticClass: "dropdown" }, [
      ...
      _c(
        ...
        [
          _c("li", [_c("a", { attrs: { href: "#" } }, [_vm._v("Crear")])]),
          _vm._v(" "),
            ...
            _vm._l(_vm.modules, function(module) {
              return _vm.modules.length
                ? _c("li", { key: module.id }, [
                    _c(
                      "a",
                      { staticClass: "redirect", attrs: { href: module.url } },
                      [
                    ...
                    module.childrens
                      ? _c(
                          "ul",
                          { staticClass: "nav" },
                          _vm._l(module.childrens, function(mod) {
                            return _c("sub-module", {
                              key: mod.id,
                              attrs: { subModule: mod }
                            })
