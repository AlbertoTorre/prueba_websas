...
Component.options.__file = "resources/assets/js/components/FormGeneral.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5de2811d", Component.options)
  } else {
    hotAPI.reload("data-v-5de2811d", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__plugins_event_bus__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_v_toaster_evolution__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_v_toaster_evolution___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_v_toaster_evolution__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_v_toaster_evolution_dist_v_toaster_evolution_css__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_v_toaster_evolution_dist_v_toaster_evolution_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_v_toaster_evolution_dist_v_toaster_evolution_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vee_validate__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utilities_locate_vee_validate_es__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utilities_locate_vee_validate_es___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__utilities_locate_vee_validate_es__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Module_vue__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Module_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__components_Module_vue__);
...
__WEBPACK_IMPORTED_MODULE_4_vee_validate__["a" /* Validator */].localize('es', __WEBPACK_IMPORTED_MODULE_5__utilities_locate_vee_validate_es___default.a);
...
Vue.use(__WEBPACK_IMPORTED_MODULE_4_vee_validate__["b" /* default */], config);
Vue.use(__WEBPACK_IMPORTED_MODULE_1__plugins_event_bus__["a" /* default */]);
Vue.use(__WEBPACK_IMPORTED_MODULE_2_v_toaster_evolution___default.a, { timeout: 10000 });
...
var app = new Vue({
  el: '#app',
  components: {
    Module: __WEBPACK_IMPORTED_MODULE_6__components_Module_vue___default.a
  }
});
...
(function(t,e){ true?module.exports=e():"function"==typeof define&&define.amd?define([],e):"object"==typeof exports?exports.VToasterEvolution=e():t.VToasterEvolution=e()})(this,function(){return function(t){function e(o){if(n[o])return n[o].exports;var r=n[o]={i:o,l:!1,exports:{}};return t[o].call(r.exports,r,r.exports,e),r.l=!0,r.exports}var n={};return e.m=t,e.c=n,e.i=function(t){return t},e.d=function(t,n,o){e.o(t,n)||Object.defineProperty(t,n,{configurable:!1,enumerable:!0,get:o})},e.n=function(t){var n=t&&t.__esModule?function(){return t.default}:function(){return t};return e.d(n,"a",n),n},e.o=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)},e.p=".",e(e.s=6)}([function(t,e,n){var o=n(3);o.install=function(t,e){t.prototype.$toasterE=new(t.extend(o))({propsData:e})},t.exports=o},function(t,e,n){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.default={props:{timeout:{type:Number,default:1e4}},methods:{success:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};this.add(t,{theme:"success",timeout:e.timeout,mark:e.mark,html:e.html})},info:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};this.add(t,{theme:"info",timeout:e.timeout,mark:e.mark,html:e.html})},warning:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};this.add(t,{theme:"warning",timeout:e.timeout,mark:e.mark,html:e.html})},error:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};this.add(t,{theme:"error",timeout:e.timeout,mark:e.mark,html:e.html})},html:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};this.add(t,{theme:e.theme,timeout:e.timeout,mark:e.mark,html:e.html})},add:function(t,e){var n=this,o=e.theme,r=e.timeout,i=e.mark,s=e.html;this.$parent||(this.$mount(),document.body.appendChild(this.$el));var a=Date.now()-Math.random();i&&(a=i,this.search(i));var u={message:t,theme:"v-toast-"+o,key:a,html:s};this.items.push(u),setTimeout(function(){return n.remove(u)},r||this.timeout)},remove:function(t){var e=this.items.indexOf(t);e>=0&&this.items.splice(e,1)},search:function(t){for(var e in this.items)this.items[e].key==t&&this.items.splice(e,1)}},data:function(){return{items:[]}}}},function(t,e){},function(t,e,n){n(2);var o=n(4)(n(1),n(5),"data-v-3e7a2138",null);t.exports=o.exports},function(t,e){t.exports=function(t,e,n,o){var r,i=t=t||{},s=typeof t.default;"object"!==s&&"function"!==s||(r=t,i=t.default);var a="function"==typeof i?i.options:i;if(e&&(a.render=e.render,a.staticRenderFns=e.staticRenderFns),n&&(a._scopeId=n),o){var u=a.computed||(a.computed={});Object.keys(o).forEach(function(t){var e=o[t];u[t]=function(){return e}})}return{esModule:r,exports:i,options:a}}},function(t,e){t.exports={render:function(){var t=this,e=t.$createElement,n=t._self._c||e;return n("div",{staticClass:"v-toaster-evolution"},[n("transition-group",{attrs:{name:"v-toast"}},t._l(t.items,function(e){return n("div",{key:e.key,staticClass:"v-toast",class:(o={},o[e.theme]=e.theme,o)},[n("a",{class:(r={},r[e.theme+"-btn-clear"]=e.theme+"-btn-clear",r),on:{click:function(n){t.remove(e)}}}),e.html?n("span",{domProps:{innerHTML:t._s(e.message)}}):t._e(),e.html?t._e():n("span",[t._v(t._s(e.message))])]);var o,r}))],1)},staticRenderFns:[]}},function(t,e,n){t.exports=n(0)}])});
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js!./v-toaster-evolution.css", function() {
			var newContent = require("!!../../css-loader/index.js!./v-toaster-evolution.css");
...
// module
exports.push([module.i, ".v-toaster-evolution[data-v-3e7a2138]{position:fixed;top:50px;right:0;z-index:10000;width:300px;padding-left:10px;padding-right:10px}.v-toaster-evolution .v-toast[data-v-3e7a2138]{margin-bottom:10px;transition:all .6s ease;border:1px solid #7b90ef;border-radius:3px;color:#444;display:block;padding:10px 7px 18px 20px;font-weight:700;background:#fff;border:3px solid #7b90ef;border-left:8px solid #7b90ef}.v-toaster-evolution .v-toast.v-toast-enter[data-v-3e7a2138],.v-toaster-evolution .v-toast.v-toast-leave-to[data-v-3e7a2138]{-ms-transform:translate(100%);transform:translate(100%)}.v-toaster-evolution .v-toast.v-toast-success[data-v-3e7a2138]{background:#fff;border:3px solid #32b643;border-left:8px solid #32b643}.v-toaster-evolution .v-toast.v-toast-warning[data-v-3e7a2138]{background:#fff;border:3px solid #ffb700;border-left:8px solid #ffb700}.v-toaster-evolution .v-toast.v-toast-info[data-v-3e7a2138]{background:#fff;border:3px solid #5bc0de;border-left:8px solid #5bc0de}.v-toaster-evolution .v-toast.v-toast-error[data-v-3e7a2138]{background:#fff;border:3px solid #e85600;border-left:8px solid #e85600}.v-toaster-evolution .v-toast.v-toast-primary[data-v-3e7a2138]{background:#fff;border:3px solid #428bca;border-left:8px solid #428bca}.v-toaster-evolution .v-toast.v-toast-warning[data-v-3e7a2138]:before{background-color:#ffb700}.v-toaster-evolution .v-toast.v-toast-error[data-v-3e7a2138]:before,.v-toaster-evolution .v-toast.v-toast-warning[data-v-3e7a2138]:before{font-size:34px;font-weight:700;position:absolute;margin-top:-3px;left:-6px;color:#fff;content:\"!\";width:40px;height:40px;border-radius:100%;text-align:center;line-height:41px}.v-toaster-evolution .v-toast.v-toast-error[data-v-3e7a2138]:before{background-color:#e85600}.v-toaster-evolution .v-toast.v-toast-success[data-v-3e7a2138]:before{background-color:#32b643}.v-toaster-evolution .v-toast.v-toast-info[data-v-3e7a2138]:before,.v-toaster-evolution .v-toast.v-toast-success[data-v-3e7a2138]:before{font-size:34px;font-weight:700;position:absolute;margin-top:-3px;left:-6px;color:#fff;content:\"!\";width:40px;height:40px;border-radius:100%;text-align:center;line-height:41px}.v-toaster-evolution .v-toast.v-toast-info[data-v-3e7a2138]:before{background-color:#5bc0de}.v-toaster-evolution .v-toast .v-toast-error-btn-clear[data-v-3e7a2138]{height:20px;width:20px;background:transparent;border:0;color:currentColor;opacity:.45;text-decoration:none;float:right;cursor:pointer;line-height:1.5;text-align:center}.v-toaster-evolution .v-toast .v-toast-error-btn-clear[data-v-3e7a2138]:before{content:\"\\2715\"}.v-toaster-evolution .v-toast .v-toast-error-btn-clear[data-v-3e7a2138]:hover{opacity:.85;border-radius:50px;box-shadow:0 0 0 2px #fff,0 0 0 4px rgba(232,86,0,.4);background-color:#e85600;color:#fff}.v-toaster-evolution .v-toast .v-toast-warning-btn-clear[data-v-3e7a2138]{height:20px;width:20px;background:transparent;border:0;color:currentColor;opacity:.45;text-decoration:none;float:right;cursor:pointer;line-height:1.5;text-align:center}.v-toaster-evolution .v-toast .v-toast-warning-btn-clear[data-v-3e7a2138]:before{content:\"\\2715\"}.v-toaster-evolution .v-toast .v-toast-warning-btn-clear[data-v-3e7a2138]:hover{opacity:.85;border-radius:50px;box-shadow:0 0 0 2px #fff,0 0 0 4px rgba(255,183,0,.4);background-color:#ffb700;color:#fff}.v-toaster-evolution .v-toast .v-toast-info-btn-clear[data-v-3e7a2138]{height:20px;width:20px;background:transparent;border:0;color:currentColor;opacity:.45;text-decoration:none;float:right;cursor:pointer;line-height:1.5;text-align:center}.v-toaster-evolution .v-toast .v-toast-info-btn-clear[data-v-3e7a2138]:before{content:\"\\2715\"}.v-toaster-evolution .v-toast .v-toast-info-btn-clear[data-v-3e7a2138]:hover{opacity:.85;border-radius:50px;box-shadow:0 0 0 2px #fff,0 0 0 4px rgba(91,192,222,.4);background-color:#5bc0de;color:#fff}.v-toaster-evolution .v-toast .v-toast-success-btn-clear[data-v-3e7a2138]{height:20px;width:20px;background:transparent;border:0;color:currentColor;opacity:.45;text-decoration:none;float:right;cursor:pointer;line-height:1.5;text-align:center}.v-toaster-evolution .v-toast .v-toast-success-btn-clear[data-v-3e7a2138]:before{content:\"\\2715\"}.v-toaster-evolution .v-toast .v-toast-success-btn-clear[data-v-3e7a2138]:hover{opacity:.85;border-radius:50px;box-shadow:0 0 0 2px #fff,0 0 0 4px rgba(50,182,67,.4);background-color:#32b643;color:#fff}@media (max-width:300px){.v-toaster-evolution[data-v-3e7a2138]{width:100%}}", ""]);
...
!function (e, n) {
  "object" == ( false ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = n() :  true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = (n),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : (e.__vee_validate_locale__es = e.__vee_validate_locale__es || {}, e.__vee_validate_locale__es.js = n());
}(this, function () {
  "use strict";
  var e = function e(_e) {
    var n = 0 === (_e = 1024 * Number(_e)) ? 0 : Math.floor(Math.log(_e) / Math.log(1024));return 1 * (_e / Math.pow(1024, n)).toFixed(2) + " " + ["Byte", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"][n];
  },
      n = { name: "es", messages: { _default: function _default(e) {
        return "El campo no es válido.";
      }, after: function after(e, n) {
        var o = n[0];return "El campo debe ser posterior " + (n[1] ? "o igual " : "") + "a " + o + ".";
      }, alpha_dash: function alpha_dash(e) {
        return "El campo solo debe contener letras, números y guiones.";
      }, alpha_num: function alpha_num(e) {
        return "El campo solo debe contener letras y números.";
      }, alpha_spaces: function alpha_spaces(e) {
        return "El campo solo debe contener letras y espacios.";
      }, alpha: function alpha(e) {
        return "El campo solo debe contener letras.";
      }, before: function before(e, n) {
        var o = n[0];return "El campo debe ser anterior " + (n[1] ? "o igual " : "") + "a " + o + ".";
      }, between: function between(e, n) {
        return "El campo debe estar entre " + n[0] + " y " + n[1] + ".";
      }, confirmed: function confirmed(e) {
        return "El campo no coincide.";
        ...
        return "El campo debe tener formato formato " + n[0] + ".";
      }, decimal: function decimal(e, n) {
        void 0 === n && (n = []);var o = n[0];return void 0 === o && (o = "*"), "Númerico y contener " + ("*" === o ? "" : o) + " puntos decimales.";
      }, digits: function digits(e, n) {
        return "El campo debe ser númerico y contener exactamente " + n[0] + " dígitos.";
      }, dimensions: function dimensions(e, n) {
        return "El campo debe ser de " + n[0] + " pixeles por " + n[1] + " pixeles.";
      }, email: function email(e) {
        return "El campo debe ser un correo electrónico válido.";
      }, ext: function ext(e) {
        return "El campo debe ser un archivo válido.";
      }, image: function image(e) {
        return "El campo debe ser una imagen.";
      }, in: function _in(e) {
        return "El campo debe ser un valor válido.";
      }, integer: function integer(e) {
        return "El campo debe ser un entero.";
      }, ip: function ip(e) {
        return "El campo debe ser una dirección ip válida.";
      }, length: function length(e, n) {
        var o = n[0],
            r = n[1];return r ? "El largo del campo debe estar entre " + o + " y " + r + "." : "El largo del campo debe ser " + o + ".";
      }, max: function max(e, n) {
        return "El campo no debe ser mayor a " + n[0] + " caracteres.";
      }, max_value: function max_value(e, n) {
        return "Valor menor a " + (parseInt(n[0]) + 1) + ".";
      }, mimes: function mimes(e) {
        return "El campo debe ser un tipo de archivo válido.";
      }, min: function min(e, n) {
        return "El campo debe tener al menos " + n[0] + " caracteres.";
      }, min_value: function min_value(e, n) {
        return "Valor mayor a " + (parseInt(n[0]) - 1) + '.';
      }, not_in: function not_in(e) {
        return "El campo debe ser un valor válido.";
      }, numeric: function numeric(e) {
        return "Digite solo numeros.";
      }, regex: function regex(e) {
        return "Caracter Inválido.";
      }, required: function required(e) {
        return "El campo es obligatorio.";
      }, size: function size(n, o) {
        var r = o[0];return "El campo " + n + " debe ser menor a " + e(r) + ".";
      }, url: function url(e) {
        return "El campo no es una URL válida.";
      } }, attributes: {} };return "undefined" != typeof VeeValidate && VeeValidate.Validator.addLocale(n), n;
});
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-73562563", Component.options)
  } else {
    hotAPI.reload("data-v-73562563", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SubModule_vue__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SubModule_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__SubModule_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__FormGeneral_vue__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__FormGeneral_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__FormGeneral_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    SubModule: __WEBPACK_IMPORTED_MODULE_0__SubModule_vue___default.a,
    FormGeneral: __WEBPACK_IMPORTED_MODULE_1__FormGeneral_vue___default.a
  },
  data: function data() {
    return {
      nameTitle: '',
  ...
  created: function created() {
    ...
    this.$bus.$on('closeForm', function () {
      _this.moduleActive = '';
      _this.moduleActiveType = '';
      _this.id = '';
      _this.parent_id = '';
    });

    this.$bus.$on('createParent', function (row) {
      _this.modules.push(row);
    });

    this.$bus.$on('updateParent', function (row) {
      _this.modules[row.index]['name'] = row.data['name'];
      _this.modules[row.index]['order'] = row.data['order'];
    });
  },

  methods: {
    showCreate: function showCreate(id, name) {
      this.id = 0;
      this.parent_id = id;
    ...
    showUpdate: function showUpdate(id, parent_id) {
      this.id = id;
      this.parent_id = parent_id;
      this.moduleActive = id;
      this.moduleActiveType = "update";
    },
    deleteMenuParent: function deleteMenuParent(index, module) {
      var _this2 = this;

      if (!this.inProcess) {
        this.inProcess = true;
        this.$toasterE.info("Espere por favor, mientras verificamos la eliminación", { mark: 1, html: true });
        axios.delete(baseUrl + '/module/delete/' + module.id).then(function (res) {
          if (res.data.submit) {
            _this2.modules.splice(index, 1);
            _this2.moduleActive = module.id;
            _this2.$toasterE.success(res.data.msn, { mark: 1, timeout: 4500, html: true });
          } else {
            _this2.$toasterE.warning(res.data.msn, { mark: 1, timeout: 6500, html: true });
          }
          _this2.inProcess = false;
        }).catch(function (err) {
          _this2.$toasterE.error(err, { mark: 1, timeout: 6500 });
          _this2.inProcess = false;
        });
      }
    },
    deleteMenu: function deleteMenu(row) {
      ...
      if (!this.inProcess) {
        this.inProcess = true;
        this.$toasterE.info("Espere por favor, mientras verificamos la eliminación", { mark: 1, html: true });
        axios.delete(baseUrl + '/module/delete/' + row.id).then(function (res) {
          if (res.data.submit) {
            _this3.modules[row.indexParent]['childrens'].splice(row.index, 1);
            _this3.moduleActive = row.id;
            _this3.$toasterE.success(res.data.msn, { mark: 1, timeout: 4500, html: true });
          } else {
            _this3.$toasterE.warning(res.data.msn, { mark: 1, timeout: 6500, html: true });
          }
          _this3.inProcess = false;
        }).catch(function (err) {
          _this3.$toasterE.error(err, { mark: 1, timeout: 6500 });
          _this3.inProcess = false;
        });
      }
    }
...
Component.options.__file = "resources/assets/js/components/SubModule.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-349f1aa5", Component.options)
  } else {
    hotAPI.reload("data-v-349f1aa5", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__FormGeneral_vue__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__FormGeneral_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__FormGeneral_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'SubModule',
  components: {
    FormGeneral: __WEBPACK_IMPORTED_MODULE_0__FormGeneral_vue___default.a
  },
  data: function data() {
    return {
      nameTitle: '',
  ...
  methods: {
    ...
    deleteMenu: function deleteMenu(row) {
      ...
      if (!this.inProcess) {
        ...
        axios.delete(baseUrl + '/module/delete/' + row.id).then(function (res) {
          if (res.data.submit) {
            _this2.subModule.childrens.splice(row.index, 1);
            _this2.moduleActive = row.id;
            _this2.$toasterE.success(res.data.msn, { mark: 1, timeout: 4500, html: true });
          } else {
            _this2.$toasterE.warning(res.data.msn, { mark: 1, timeout: 6500, html: true });
          }
			...
			this.$validator.validateAll().then(function (result) {
				if (result) {
					if (!_this.inProcess) {
						...
						var formData = new FormData(_this.$refs.send);
						if (_this.newId > 0) {
							formData.append('id', _this.newId);
						}
						formData.append('parent_id', _this.newParentId);
						axios.post(baseUrl + '/module/' + _this.type, formData).then(function (res) {
							if (res.data.submit) {
								if (_this.type == 'create') {
									_this.dataForm.id = res.data.id;
									var data = JSON.stringify(_this.dataForm);
									_this.create(data);
								} else if (_this.type == 'update') {
									var _data = JSON.stringify(_this.dataForm);
									_this.update(_data);
								}

								_this.dataForm.id = '', _this.dataForm.parent_id = '', _this.dataForm.name = '', _this.dataForm.url = '#', _this.dataForm.active = '', _this.dataForm.order = 0;
								_this.$validator.reset();

								_this.$toasterE.success(res.data.msn, { mark: 1, timeout: 1500 });
								_this.closeForm();
							} else {
								_this.$toasterE.error(res.data.msn, { mark: 1, timeout: 6500, html: true });
							}
							_this.inProcess = false;
						}).catch(function (err) {
							_this.$toasterE.error(err, { mark: 1, timeout: 6500 });
							_this.inProcess = false;
						});
					}
				}
...
var render = function() {
  ...
  return _c("div", [
    _c(
      ...
      [
        _c("h5", [
          _vm._v(" Crear nuevo menu ( " + _vm._s(_vm.nameTitle) + " ) ")
        ]),
        _vm._v(" "),
        _vm.dataForm.id
          ? _c("input", {
              ...
              on: {
                input: function($event) {
                  ...
                  _vm.$set(_vm.dataForm, "id", $event.target.value)
                }
              }
            })
          : _vm._e(),
        ...
        _c("input", {
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.dataForm.parent_id,
              expression: "dataForm.parent_id"
            },
            {
              name: "validate",
              rawName: "v-validate",
          ...
          domProps: { value: _vm.dataForm.parent_id },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.dataForm, "parent_id", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
        _c(
          ...
          {
            class: {
              "col-xs-10 col-md-10 col-lg-10 form-group": true,
          ...
          [
            ...
            _c(
              "div",
              {
                ...
                staticClass: "message-validate has-error"
              },
        ...
        _c(
          ...
          {
            class: {
              "col-xs-2 col-md-2 col-lg-2 form-group": true,
              "has-error": _vm.errors.has("active")
            }
          },
          [
            _c(
              "label",
              { staticClass: "control-label", attrs: { for: "active" } },
              [_vm._v(" Activo ")]
            ),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.dataForm.active,
                  expression: "dataForm.active"
                }
              ],
              staticClass: "form-control",
              attrs: { name: "active", type: "checkbox", checked: "" },
              domProps: {
                checked: Array.isArray(_vm.dataForm.active)
                  ? _vm._i(_vm.dataForm.active, null) > -1
                  : _vm.dataForm.active
              },
              on: {
                change: function($event) {
                  var $$a = _vm.dataForm.active,
                    $$el = $event.target,
                  ...
                  if (Array.isArray($$a)) {
                    ...
                    if ($$el.checked) {
                      $$i < 0 &&
                        _vm.$set(_vm.dataForm, "active", $$a.concat([$$v]))
                    } else {
                      $$i > -1 &&
                        _vm.$set(
                          _vm.dataForm,
        ...
        _c(
          ...
          {
            class: {
              "col-xs-9 col-md-9 col-lg-9 form-group": true,
            ...
            _c("input", {
              directives: [
                ...
                },
                {
                  ...
                  rawName: "v-validate",
                  value: "url|required",
                  expression: "'url|required'"
                }
              ],
              staticClass: "form-control",
              attrs: { name: "url", type: "text" },
        ...
        _c(
          ...
          {
            class: {
              "col-xs-3 col-md-3 col-lg-3 form-group": true,
              "has-error": _vm.errors.has("order")
            }
          },
          [
            _c(
              "label",
              { staticClass: "control-label", attrs: { for: "order" } },
              [_vm._v("Orden")]
            ),
            _vm._v(" "),
            _c("input", {
              ...
              staticClass: "form-control",
              attrs: { name: "order", type: "text" },
              domProps: { value: _vm.dataForm.order },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.dataForm, "order", $event.target.value)
                }
              }
            }),
            _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5de2811d", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("a", { staticClass: "redirect", attrs: { href: _vm.subModule.url } }, [
        _vm.subModule.childrens.length
          ? _c("i", { staticClass: "fa fa-sitemap" })
          : _vm._e(),
        _vm._v(" "),
        !_vm.subModule.childrens.length
          ? _c("i", { staticClass: "glyphicon glyphicon-new-window" })
          : _vm._e(),
        _vm._v(" \n      " + _vm._s(_vm.subModule.name) + "\n      "),
        _vm.subModule.childrens.length
              ...
              _c(
                "a",
                {
                  on: {
                    click: function($event) {
                      $event.preventDefault()
                      _vm.showCreate(_vm.subModule.id, _vm.subModule.name)
                    }
                  }
                },
                [_vm._v("Crear")]
              ...
              _c(
                "a",
                {
                  on: {
                    click: function($event) {
                      $event.preventDefault()
                      _vm.showUpdate(_vm.subModule.id, _vm.subModule.parent_id)
                    }
                  }
                },
                [_vm._v("Editar")]
      ...
      _vm._v(" "),
      _vm.moduleActive == _vm.subModule.id && _vm.moduleActiveType !== ""
        ? _c("form-general", {
            staticClass: "form-general",
            attrs: {
              type: _vm.moduleActiveType,
              nameTitle: _vm.nameTitle,
              newId: _vm.id,
              newParentId: _vm.parent_id,
              mod: _vm.subModule,
              index: _vm.index
            }
          })
      ...
      _vm.subModule.childrens.length
        ? _c(
            "ul",
            { staticClass: "nav" },
            _vm._l(_vm.subModule.childrens, function(subMod, index) {
              return _c("sub-module", {
                key: subMod.id,
                tag: "sub-module",
                attrs: { subModule: subMod, index: index },
                on: { deleteMenu: _vm.deleteMenu }
              })
            })
          )
        : _vm._e()
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-349f1aa5", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "sidebar-nav navbar-collapse collapse" }, [
        _c(
          "ul",
          ...
          [
            _c(
              ...
              [
                ...
                _c(
                  "button",
                  {
                    staticClass: "btn btn-success show-create-parents",
                    on: {
                      click: function($event) {
                        _vm.showCreate(0, "padre")
                      }
                    }
                  },
                  [
            ...
            _vm._v(" "),
            _vm._l(_vm.modules, function(module, indexParent) {
              return _vm.modules
                ? _c(
                    "li",
                    { key: module.id },
                    [
                      _c(
                        "a",
                        {
                          ...
                          attrs: { href: module.url }
                        },
                        [
                          _c("i", { staticClass: "fa fa-sitemap fa-fw" }),
                          _vm._v(
                            " " + _vm._s(module.name) + "\n                  "
                          ),
                          module.childrens.length
                            ? _c("span", { staticClass: "fa arrow" })
                            : _vm._e()
                        ]
                      ),
                              ...
                              _c(
                                "a",
                                {
                                  on: {
                                    click: function($event) {
                                      $event.preventDefault()
                                      _vm.showCreate(module.id, module.name)
                                    }
                                  }
                                },
                                [_vm._v("Crear")]
                              ...
                              _c(
                                "a",
                                {
                                  on: {
                                    click: function($event) {
                                      $event.preventDefault()
                                      _vm.deleteMenuParent(indexParent, module)
                                    }
                                  }
                                },
                                [_vm._v("Eliminar")]
                      ...
                      _vm._v(" "),
                      _vm.moduleActive == module.id &&
                      _vm.moduleActiveType !== ""
                        ? _c("form-general", {
                            staticClass: "form-general",
                            attrs: {
                              type: _vm.moduleActiveType,
                      ...
                      module.childrens.length
                        ? _c(
                            "ul",
                            { staticClass: "nav" },
                            _vm._l(module.childrens, function(mod, index) {
                              return _c("sub-module", {
                                key: mod.id,
                                attrs: {
                                  subModule: mod,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-73562563", module.exports)
  }
}
